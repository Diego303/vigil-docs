...
export const ui = {
  es: {
    ...
    hero: {
      ...
      installCmd: 'pip install vigil-ai-cli',
      githubBtn: 'Github',
    ...
    slopsquatting: {
      title: 'Vector de Ataque: Slopsquatting',
      subtitle: 'Los LLMs alucinan nombres de paquetes que no existen. Un atacante registra ese nombre con malware. Vigil lo intercepta antes de que llegue a tu m\u00E1quina.',
      step1Label: 'Alucinaci\u00F3n',
      step1Title: 'IA Genera C\u00F3digo',
      step1Code: 'import fastapi-auth-utils',
      step2Label: 'El Ataque',
      step2Title: 'Atacante Registra',
      step2Desc: 'El atacante sube malware a PyPI con ese nombre falso repetible.',
      step3Label: 'Intercepci\u00F3n',
      step3Title: 'Vigil Scan',
      step3Line1: '[DEP-001] CRITICAL',
      step3Line2: 'Paquete no existe o es demasiado nuevo.',
      step3Line3: '> ACCI\u00D3N: Bloqueo.',
      step4Label: 'Evitado',
      step4Title: 'Instalaci\u00F3n Local',
      step4Desc: 'El developer o CI/CD evita ejecutar pip install malicioso.',
    },
    cta: {
  ...
  en: {
    ...
    slopsquatting: {
      title: 'Attack Vector: Slopsquatting',
      subtitle: 'LLMs hallucinate package names that don\'t exist. An attacker registers that name with malware. Vigil intercepts it before it reaches your machine.',
      step1Label: 'Hallucination',
      step1Title: 'AI Generates Code',
      step1Code: 'import fastapi-auth-utils',
      step2Label: 'The Attack',
      step2Title: 'Attacker Registers',
      step2Desc: 'The attacker uploads malware to PyPI with that repeatable fake name.',
      step3Label: 'Interception',
      step3Title: 'Vigil Scan',
      step3Line1: '[DEP-001] CRITICAL',
      step3Line2: 'Package does not exist or is too new.',
      step3Line3: '> ACTION: Blocked.',
      step4Label: 'Prevented',
      step4Title: 'Local Installation',
      step4Desc: 'The developer or CI/CD avoids running malicious pip install.',
    },
    cta: {
