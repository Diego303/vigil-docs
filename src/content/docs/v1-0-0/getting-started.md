...
En la version actual (v1.0.0), los cuatro analyzers estan completamente funcionales:
...
- Integra vigil en tu CI/CD: ver [ci-cd.md](/vigil-docs/docs/v1-0-0/ci-cd/)
- Consulta los analyzers activos: ver [analizadores.md](/vigil-docs/docs/v1-0-0/analyzers/)
- Consulta la referencia CLI completa: ver [cli.md](/vigil-docs/docs/v1-0-0/cli/)
