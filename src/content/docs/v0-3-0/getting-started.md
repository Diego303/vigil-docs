...
- Integra vigil en tu CI/CD: ver [Integracion CI/CD](/vigil-docs/docs/v0-3-0/ci-cd/)
- Consulta los analyzers activos: ver [Analizadores](/vigil-docs/docs/v0-3-0/analyzers/)
- Consulta la referencia CLI completa: ver [Referencia CLI](/vigil-docs/docs/v0-3-0/cli/)
