---
title: "Analizadores"
description: "Referencia tecnica de los analyzers implementados: DependencyAnalyzer, AuthAnalyzer y SecretsAnalyzer."
order: 10
...
Para la arquitectura general de los analyzers (protocolo, registro, flujo), ver [Arquitectura](/vigil-docs/docs/v0-3-0/architecture/).
