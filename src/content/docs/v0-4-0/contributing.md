...
Agregar la regla a la [documentacion de reglas](/vigil-docs/docs/v0-4-0/rules/) con:
...
Consultar el documento de seguimiento del proyecto para el estado detallado de cada fase.
