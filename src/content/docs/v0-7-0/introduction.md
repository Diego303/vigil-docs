...
|-----------|-------------|
| [Inicio rapido](/vigil-docs/docs/v0-7-0/getting-started/) | Instalacion, primer scan y conceptos basicos |
| [Referencia CLI](/vigil-docs/docs/v0-7-0/cli/) | Todos los comandos, flags y opciones disponibles |
| [Configuracion](/vigil-docs/docs/v0-7-0/configuration/) | Archivo `.vigil.yaml`, estrategias, overrides y merge de config |
| [Reglas](/vigil-docs/docs/v0-7-0/rules/) | Catalogo completo de las 26 reglas con ejemplos de codigo vulnerable |
| [Formatos de salida](/vigil-docs/docs/v0-7-0/output-formats/) | Human, JSON, JUnit XML y SARIF 2.1.0 |
| [Integracion CI/CD](/vigil-docs/docs/v0-7-0/ci-cd/) | GitHub Actions, GitLab CI, pre-commit hooks y quality gates |
| [Docker](/vigil-docs/docs/v0-7-0/docker/) | Uso en contenedores, Dockerfile de referencia y buenas practicas |
| [Seguridad](/vigil-docs/docs/v0-7-0/security/) | Modelo de amenazas, que detecta vigil, alineacion OWASP y limitaciones |
| [Analizadores](/vigil-docs/docs/v0-7-0/analyzers/) | Referencia tecnica de los analyzers implementados (Dependency, Auth, Secrets, Test Quality) |
| [Arquitectura](/vigil-docs/docs/v0-7-0/architecture/) | Estructura interna, flujo del engine, protocolo de analyzers |
| [Buenas practicas](/vigil-docs/docs/v0-7-0/best-practices/) | Recomendaciones para equipos que usan agentes de IA para generar codigo |
| [Compliance y uso empresarial](/vigil-docs/docs/v0-7-0/compliance/) | Alineacion con OWASP, CRA, SOC 2, ISO 27001, NIST y uso en pipelines empresariales |
| [Contribuir](/vigil-docs/docs/v0-7-0/contributing/) | Guia para contribuir al proyecto, setup de desarrollo y testing |
