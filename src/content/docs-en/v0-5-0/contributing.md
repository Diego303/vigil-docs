...
Order: stdlib, third-party, local. Ruff handles sorting them.
...
Overall coverage: **~98%** (99% in the reports module)
...
Consult `SEGUIMIENTO-V0.md` for the detailed status of each phase.
