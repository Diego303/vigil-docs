...
CLI flags always have the highest priority. This allows having a base configuration file for the team and making per-execution adjustments.
...
deps:
  ...
  # Uses the bundled corpus in data/ by default
