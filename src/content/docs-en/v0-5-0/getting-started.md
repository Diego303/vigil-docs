...
- Integrate vigil in your CI/CD: see [CI/CD Integration](/vigil-docs/en/docs/v0-5-0/ci-cd/)
- Check the active analyzers: see [Analyzers](/vigil-docs/en/docs/v0-5-0/analyzers/)
- Check the complete CLI reference: see [CLI Reference](/vigil-docs/en/docs/v0-5-0/cli/)
