...
- Integrate vigil in your CI/CD: see [CI/CD Integration](/vigil-docs/en/docs/v0-2-0/ci-cd/)
- Check active analyzers: see [Analyzers](/vigil-docs/en/docs/v0-2-0/analyzers/)
- Check the full CLI reference: see [CLI Reference](/vigil-docs/en/docs/v0-2-0/cli/)
