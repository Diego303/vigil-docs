...
For runners without internet access or on restricted networks:
...
4. **Pin the vigil version**: In production Dockerfiles, use `pip install vigil-ai-cli==0.2.0` instead of `vigil-ai-cli` for reproducible builds.
