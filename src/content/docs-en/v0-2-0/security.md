...
3. The developer reviews superficially and approves the PR
...
**Disadvantages:**
- Cannot detect novel issues that were not anticipated in the rules.
...
- Are cached locally in `~/.cache/vigil/registry/` with a configurable TTL (default 24h).
