...
- Integrate vigil into your CI/CD: see [CI/CD Integration](/vigil-docs/en/docs/v0-4-0/ci-cd/)
- Check active analyzers: see [Analyzers](/vigil-docs/en/docs/v0-4-0/analyzers/)
- See the full CLI reference: see [CLI Reference](/vigil-docs/en/docs/v0-4-0/cli/)
