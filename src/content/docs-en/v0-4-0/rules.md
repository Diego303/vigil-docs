...
**What it detects:** A hardcoded secret with low entropy (probably generated by the AI agent carelessly).
...
> **Status: IMPLEMENTED** -- The `TestQualityAnalyzer` has been active since v0.4.0. All rules TEST-001 through TEST-006 are implemented. Supports pytest/unittest (Python) and jest/mocha (JavaScript/TypeScript).
