...
Add the rule to the [Rules](/vigil-docs/en/docs/v0-4-0/rules/) documentation with:
...
- Use `tmp_path` from pytest for temporary files.
...
See the project tracking document for detailed status of each phase.
