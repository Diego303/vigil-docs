...
In the current version (v0.7.0), all four analyzers are fully functional:

### Dependency Analyzer (DEP-001 to DEP-007)
...
### Auth Analyzer (AUTH-001 to AUTH-007)
...
### Secrets Analyzer (SEC-001 to SEC-006)
...
### Test Quality Analyzer (TEST-001 to TEST-006)
...
- Detects mock mirrors (test only verifies the mock works)
...
- Integrate vigil into your CI/CD: see [CI/CD Integration](/vigil-docs/en/docs/v0-7-0/ci-cd/)
- Check the active analyzers: see [Analyzers](/vigil-docs/en/docs/v0-7-0/analyzers/)
- Check the full CLI reference: see [CLI Reference](/vigil-docs/en/docs/v0-7-0/cli/)
