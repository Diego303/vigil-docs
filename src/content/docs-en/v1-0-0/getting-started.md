...
In the current version (v1.0.0), all four analyzers are fully functional:
...
- Integrate vigil into your CI/CD: see [CI/CD Integration](/vigil-docs/en/docs/v1-0-0/ci-cd/)
- Check the active analyzers: see [Analyzers](/vigil-docs/en/docs/v1-0-0/analyzers/)
- Check the full CLI reference: see [CLI Reference](/vigil-docs/en/docs/v1-0-0/cli/)
